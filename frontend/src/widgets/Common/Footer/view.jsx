      ...
      <div className="w-full flex gap-4">
        <div className="flex-1 pr-3">
          ...
          <div className="p-4 pr-8 text-justify">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur at fugiat laboriosam aspernatur praesentium possimus repudiandae.
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col gap-y-4">
          <div className="w-full justify-end flex flex-col  gap-y-4">
            ...
            <div className="flex gap-4 mt-3">
              <FontAwesomeIcon icon={faFacebook} className="h-7 cursor-pointer" />
              <FontAwesomeIcon icon={faWhatsapp} className="h-7 cursor-pointer" />
              <FontAwesomeIcon icon={faInstagram} className="h-7 cursor-pointer" />
            </div>
          </div>
        </div>
      </div>
