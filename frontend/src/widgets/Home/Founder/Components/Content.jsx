...
export default function Content() {
  return (
    <div className="flex w-screen bg-primary-50 px-5vw py-16 pt-16 bg-no-repeat bg-cover">
      <div className="flex w-full items-center justify-center flex-col gap-5">
        ...
        />
        <span className="text-2xl font-semibold text-primary">Our Founder</span>
        <span className="text-4xl font-bold text-font-secondary">
